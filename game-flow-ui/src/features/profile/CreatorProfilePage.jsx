...
export default function CreatorProfilePage() {
  ...
  const creator = {
    ...
    ...(publicProfile ? {
      ...
      companionMotion: publicProfile.companionMotion || 'subtle',
      companionEmotion: publicProfile.companionEmotion || 'natural',
      ...
      profileDesignDensity: publicProfile.profileDesignDensity || 'balanced',
      profileDesignLineStyle: publicProfile.profileDesignLineStyle || 'clean',
      profileDesignMotion: publicProfile.profileDesignMotion || 'subtle',
      profileDesignInteraction: publicProfile.profileDesignInteraction || 'rearrange',
      profileDesignDoodleTheme: publicProfile.profileDesignDoodleTheme || 'Developer',
